...
const currentLangFlag = computed(() => (isAr.value ? '🇸🇦' : '🇺🇸'))
            ...
            <div class="col-2 col-md-4 d-none d-xl-block ">
              ...
              <div class="actions-section">
                <div class="row mobile-none" >
                  <div class="col-6">
                    <div class="info-left" style="float: left;width: 90%;border-radius:25px;background: #fff;">
                      <div class="d-flex align-items-center gap-2 justify-content-around ">
                        ...
                        <div class="info-content text-center ">
                          <p style="font-size: 12px;"  class="mb-0 fw-bold">{{ t('support_24_7') || 'دعم 24/7' }}
                            <br>
                  ...
                  <div class="col-6">
                    <div class="info-left" style="float: left;width: 90%;border-radius:25px;background: #fff;">
                      <div class="d-flex align-items-center gap-2 justify-content-center ">
                        ...
                        <div class="info-content text-center ">
                          <p style="font-size: 12px;"  class="mb-0 fw-bold">{{ t('free_shipping') || 'شحن مجاني' }}
                            <br>
