  ...
  <div class="wrap">
    ...
    <div v-else class="product">
      ...
      <div class="info">
        ...
        <!-- Product SKU -->
        <div v-if="currentVariantSku || productSku" class="product-sku search-box-desktop">
          <span class="sku-label">{{ t('product.sku') || 'رمز المنتج' }}:</span>
          <span class="sku-value">{{ currentVariantSku || productSku }}</span>
        </div>
        ...
        <!-- Color Selection -->
        <div v-if="availableColors.length > 0" class="variant-section search-box-desktop">
          <div class="variant-title-wrapper">
          <h4 class="variant-title">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
        ...
        <div v-if="availableVariations.length > 0" class="variant-section search-box-desktop">
          ...
          <div class="size-options">
            ...
            >
              ...
              <span v-if="getVariationQty(option) === 0" class="out-of-stock-badge">{{ t('product.out_of_stock') || 'غير متوفر' }}</span>
            </button>
          </div>
        </div>
        <!-- Add to Cart -->
