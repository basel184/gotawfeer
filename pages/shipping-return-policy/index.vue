...
<main class="container py-5">
    ...
    <ul>
              ...
              <li>{{ t('shipping_return.return.non_returnable.oud_wood') }}</li>
              <li>{{ t('shipping_return.return.non_returnable.oud_oil') }}</li>
              <li>{{ t('shipping_return.return.non_returnable.musk') }}</li>
